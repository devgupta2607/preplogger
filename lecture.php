<html>
	...
	<body>
		...
		<br/>
		<a style="font-weight: 100; position: relative; color: #777; text-decoration: none;" href="add_topic.php">add topics ></a>
		<br/>
		<br/>
		<div id="lecture_sessions">
			...
			<br/>
			<table align="right" style="position: relative; width: 80%;" border="0">
				<tr>
					<td>
